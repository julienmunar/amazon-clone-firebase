...
const PromoContainer = () => {
    return (
        <div className=' xl:-mt-52 relative z-30  grid grid-flow-row  grid-cols-2 md:grid-cols-4 m-2 gap-2'>
            <PromoElement
            ...
            <PromoElement title="Accessoires Echo " link="en savoir plus" >
                <div className='bg-[#F2FAFB] p-2'>
                    <img className=' object-contain' src='	https://m.media-amazon.com/images/I/61pjrxGyK3S._AC_SY450_.jpg' />
                </div>
                <div  className='bg-[#F2FAFB] p-2'>
                    <img className=' object-contain' src='	https://m.media-amazon.com/images/I/41k8O1MfmOS._AC_.jpg' />
                </div>
                <div className='bg-[#F2FAFB] p-2'>
                    <img className=' object-contain' src='https://m.media-amazon.com/images/I/61GHjOxgI1S._AC_SL1500_.jpg' />
                </div>
                <div  className='bg-[#F2FAFB] p-2'>
                    <img className=' object-contain' src='https://m.media-amazon.com/images/I/81oAfxMzgNL._AC_SX679_.jpg' />
                </div>
...
const PromoElement = (props) => {
    return (
        <div className='bg-white p-2 flex  flex-col items-center' >
            ...
            {props.image && <img src={props.image} alt="" width={315} height={275}  className=' object-contain pb-3' />}
            <div className='grid grid-cols-2 grid-flow-row p-3 gap-1'>
                {props.children}
            </div>
